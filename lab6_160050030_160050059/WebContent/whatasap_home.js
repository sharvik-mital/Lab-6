...
//    	e.preventDefault();
        txt="<button id=\"button1\" onclick=\"createconversation2()\">"+ "Create Conversation" +"</button>";
      	document.getElementById("content").innerHTML = txt;
...
//	          		txt+="<td>"+"<button onclick=\"DeleteMessage\">"+"delete message"+"</button>"   +"<td>";
	          		txt+="</tr>";
	          	}
	          	txt+="</table>";
			    ...
			    "</form>";	
			    txt+="<button onclick=\"SubmitMessage()\">"+ "Send Message" +"</button>";
	          	document.getElementById("content").innerHTML = txt;
//	            $("#etail").DataTable({
